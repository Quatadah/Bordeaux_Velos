...
DELIMITER //
CREATE PROCEDURE update_date_retour_emprunt(date_retour DATETIME, numero_emprunt INT ) 
BEGIN
    update EMPRUNT 
...
DELIMITER //
CREATE PROCEDURE update_station_retour_emprunt(station INT, numero_emprunt INT ) 
BEGIN
    update EMPRUNT 
...
DELIMITER //
CREATE PROCEDURE  supprimer_velo(reference INT)
BEGIN
    DELETE from VELO
    WHERE VELO.NUMERO_REFERENCE=reference;
END //
...
DELIMITER //
CREATE PROCEDURE  supprimer_emprunt(reference INT)
BEGIN
    DELETE from EMPRUNT
...
DELIMITER //
CREATE PROCEDURE  supprimer_station(reference INT)
BEGIN
    DELETE from STATION
...
DELIMITER //
CREATE PROCEDURE  supprimer_usager(reference INT)
BEGIN
    DELETE from USAGER
...
DELIMITER //
CREATE PROCEDURE diminuer_niveau_charge(reference INT, distance_parcourue DECIMAL, date_prise DATE, date_rendu DATE )
BEGIN
    DECLARE charge INT;
...
DELIMITER //
CREATE PROCEDURE augmenter_niveau_charge(reference INT)
BEGIN
    DECLARE station INT;
